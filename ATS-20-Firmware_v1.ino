//DISCLAIMER: Original Code is from https://github.com/pu2clr/SI4735/blob/master/examples/SI47XX_ATS20_ATS20%2B/SI473X_ALL_IN_ONE_OLED_RDS_CHINESE_V9/SI473X_ALL_IN_ONE_OLED_RDS_CHINESE_V9/SI473X_ALL_IN_ONE_OLED_RDS_CHINESE_V9.ino
/*
...
#define DEFAULT_VOLUME 60  // Volume stays at this value in the software, the volume is controlled by the VOLUME knob only.
...
/**
   Changes the volume based on encoder rotation; COMMENTED TO DISABLE; VOLUME pot controls the loudness.
